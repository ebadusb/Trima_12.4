/* config.h - Bobcat configuration header */
 
/* VersaLogic Corporation Bobcat BSP 
 *
 *  Note: This BSP is based on WindRiver's pc486 BSP. Specifically, this
 *        file represents a revision of WindRiver's config.h and all revision
...
--------------------
05a,25may03,ss   Initial VersaLogic Bobcat BSP release
...
#define BSP_REV		"/4"	/* 2.1 for Tornado 2.2.1 */
...
/* use 0x80 for flags to force TFTP transfer. Needed for the SMC (not SMsC) Ampro Safety ethernet */
#define DEFAULT_BOOT_LINE \
"ene(0,0)control_safety:/trima/safety/boot/vxWorks e=10.0.0.1:ffffff00 h=10.0.0.2 tn=safety u=" INTFTPUSER " pw=" INTFTPPASS " f=0x80"
...
#       undef INCLUDE_BSD      /* include BSD / Netif Driver Support */
#       undef INCLUDE_ELT      /* (BSD) 3Com EtherLink III interface */
...
#   define SYSTEM_RAM_SIZE      (0x02000000)    /* minimum 8MB system RAM */
...
#define ADDED_BOOTMEM_SIZE      (0x00100000)     /* no additional memory */
