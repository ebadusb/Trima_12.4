...
//  IT4823
   ...
   {
      NON_AUTOFLOW_TIME_DQ,
      // NAME_LITERAL("NON AUTOFLOW TIME DISQUALIFICATION")
      ALARM_OPT_DISALLOW_END_RUN | ALARM_OPT_DISALLOW_RINSEBACK,
      NonAutoFlowTextAlarmBodyTimeout,
...

   {
      ...
      ALARM_OPT_DISALLOW_END_RUN | ALARM_OPT_DISALLOW_ADJUST | ALARM_OPT_DISALLOW_RINSEBACK,
      JPHtextAlarmBodyAFtenMin,
      JPHtextStatAlarmAFtenMin,
      BITMAP_AUTO_FLOW_TIME_INCREASE_CLOCKONLY
   },

   {
      ...
      // NAME_LITERAL("AUTOFLOW TIME ALERT")
      ALARM_OPT_DISALLOW_END_RUN | ALARM_OPT_DISALLOW_ADJUST | ALARM_OPT_DISALLOW_RINSEBACK,
      textAlarmBodyWithGraphicAFtenMin02,
      JPHtextStatAlarmAFtenMin,
      BITMAP_AUTO_FLOW_TIME_INCREASE_NEEDLE
   },

   {
      ...
      // NAME_LITERAL("AUTOFLOW TIME ALERT")
      ALARM_OPT_DISALLOW_END_RUN | ALARM_OPT_DISALLOW_ADJUST | ALARM_OPT_DISALLOW_RINSEBACK,
      textAlarmBodyWithGraphicAFtenMin03,
      JPHtextStatAlarmAFtenMin,
      BITMAP_AUTO_FLOW_TIME_INCREASE_SQUEEZING
   },

   {
      ...
      // NAME_LITERAL("AUTOFLOW TIME ALERT")
      ALARM_OPT_DISALLOW_END_RUN | ALARM_OPT_DISALLOW_ADJUST | ALARM_OPT_DISALLOW_RINSEBACK,
      textAlarmBodyWithGraphicAFtenMin04,
      JPHtextStatAlarmAFtenMin,
      BITMAP_DONOR_WARM
   },

   {
      ...
      // NAME_LITERAL("AUTOFLOW TIME ALERT")
      ALARM_OPT_DISALLOW_END_RUN | ALARM_OPT_DISALLOW_ADJUST | ALARM_OPT_DISALLOW_RINSEBACK,
      textAlarmBodyNoGraphicAFtenMin05,
      JPHtextStatAlarmAFtenMin,
   },
   ///////////////////////
   {
      AUTOFLOW_TIME_ALARM,
      NAME_LITERAL("AUTOFLOW_TIME_ALARM")
      ALARM_OPT_DISALLOW_END_RUN | ALARM_OPT_DISALLOW_ADJUST | ALARM_OPT_DISALLOW_RINSEBACK,
      JPHtextAlarmBodyAFtenMin,
      JPHtextStatAlarmAFtenMin,
      BITMAP_AUTO_FLOW_TIME_INCREASE
   },

   {
      AUTOFLOW_TIME_ALARM,
      // NAME_LITERAL("AUTOFLOW TIME ALARM")
      ALARM_OPT_DISALLOW_END_RUN | ALARM_OPT_DISALLOW_ADJUST | ALARM_OPT_DISALLOW_RINSEBACK,
      textAlarmBodyWithGraphicAFtenMin02,
      JPHtextStatAlarmAFtenMin,
      BITMAP_AUTO_FLOW_TIME_INCREASE_NEEDLE
