...
*     File name:   acConnectConfirmBox.hpp

*     Contents:    See prototype header descriptions below...

*     Description: This class represents a confirm box for the AC connection
...
#ifndef _AC_CONNECT_CONFIRM_BOX_HPP_
#define _AC_CONNECT_CONFIRM_BOX_HPP_

/** include files **/
#include "confirmBoxBase.hpp"

class Screen_AC_CONNECT_CONFIRM_BOX
...
public:
   ...
   // CONSTRUCTOR
   Screen_AC_CONNECT_CONFIRM_BOX();

   // DESTRUCTOR
   virtual ~Screen_AC_CONNECT_CONFIRM_BOX();
...
/* FORMAT HASH 7beef10f39453542b4d92dfc1340bd93 */
