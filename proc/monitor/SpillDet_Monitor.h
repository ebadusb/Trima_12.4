 ...
 *
 * TITLE:      SpillDet_Monitor.h
 *
 * ABSTRACT:  This is the include file for the SpillDet monitor.
 *
 */


#ifndef SpillDet_MONITOR_H
#define SpillDet_MONITOR_H

#include "aPQMonitor.h"
#include "objdictionary.h"
#include "trimamessages.h"

class SpillDet_Monitor
   : public aPQMonitor
{
   // Declare this class to the object dictionary
   DECLARE_OBJ(SpillDet_Monitor);
...
private:
   ...
   SpilloverDetectedMsg _SpillDetMsg;

   ProcData             _pd;

   bool                 _spilloverDetected;
};


#endif

/* FORMAT HASH 85762404cd2526ee6ead97a427bb9639 */
