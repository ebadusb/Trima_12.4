 ...
 *
 * TITLE:      AirBlock_Monitor.h
 *
 * ABSTRACT:  This is the include file for the AirBlock monitor.
 *
 */


#ifndef AirBlock_MONITOR_H
#define AirBlock_MONITOR_H

#include "aPQMonitor.h"
#include "objdictionary.h"
#include "trimamessages.h"

class AirBlock_Monitor
   : public aPQMonitor
{
   // Declare this class to the object dictionary
   DECLARE_OBJ(AirBlock_Monitor);
...
private:
   ...
   AirInPlasmaLineMsg _AirInPlasmaLineMsg;
};


#endif

/* FORMAT HASH 46bc5654efc77da2d65152e793fa3d4f */
