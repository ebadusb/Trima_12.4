...
/* SMC 91c9x driver definitions */
#ifdef INCLUDE_ESMC_END

#define END_ESMC_LOAD_FUNC    sysEsmcEndLoad
#define END_ESMC_BUFF_LOAN    TRUE
#define END_ESMC_LOAD_STRING  ""

IMPORT END_OBJ * END_ESMC_LOAD_FUNC (char *, void *);
...
/* The following #ifdefs are commented out to allow
   for network autodetection. */
...
#ifdef INCLUDE_ESMC_END
    {0, END_ESMC_LOAD_FUNC, END_ESMC_LOAD_STRING, END_ESMC_BUFF_LOAN,
    NULL, FALSE},
#endif
