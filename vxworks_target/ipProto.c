...
--------------------
03q,16sep03,rae  fix compiler warnings
03p,28jul03,rae  remove virtualStackIdCheck() call
03o,12may03,rp   virtualize proxyArpDefault variable
03n,16apr03,rae  fix last checkin
03m,12mar03,rae  enable default proxy arp for interfaces
...
LOCAL BOOL proxyArpDefault = FALSE;
#endif /* VIRTUAL_STACK */
...
LOCAL void ipTkError ( void * ipCallbackId,  END_ERR* pError);
...
LOCAL STATUS ipShutdownRtn
    ...
    netClFree (_pNetDpool, (UCHAR *)pDrvCtrl->pDstAddr);
...
/* Get storage for link-level destination addresses. */
    ...
    switch (mib2Tbl.ifType)
        ...
        case M2_ifType_fddi:
            ...
            bcopy ((char *)mib2Tbl.ifPhysAddress.phyAddress,
                   (char *)pDrvCtrl->idr.ac_enaddr, pIfp->if_addrlen);
    ...
    if (proxyArpDefault && !(pIfp->if_flags & IFF_NOARP))
        pIfp->if_flags |= IFF_PROXY_ALL;
