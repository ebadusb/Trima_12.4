...
runner.AddCommand('spoof_main "-enable -object SHwStates -data cassettePosition -value HW_CASSETTE_DOWN"\n','->',False)
...
raw_input("At two button screen, press ENTER to spoof cassette position to 'DOWN'.")
runner.Run()
...
#runner.AddCommand('spoof_main "-unspoof -object <Spoofed Object Here> -data <Spoofed Data Here>"\n','->',False)
raw_input("Cassette position is being spoofed to 'DOWN', press ENTER to close this window.")
