...
def main():
    ...
    raw_input("\n\n\nAC Prime state spoofed press ENTER to continue: ")
    
    raw_input("\nAfter dlog download, press ENTER to reboot machine and close this window: ")
