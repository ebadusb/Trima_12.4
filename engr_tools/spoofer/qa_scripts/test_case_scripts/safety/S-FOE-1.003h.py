# FILENAME: S-FOE-1.003h_platelet_to_open.py
# PURPOSE: Spoofs Platelet valve position to safety Open

spoofName = "S-FOE-1.003h_platelet_to_open.py"
...
# add spoof commands
runner.AddCommand('spoof_main "-object SHwStates -data plateletValve -value HW_VALVE_OPEN"\n','->',False)
