# FILENAME: S-PSS-1.001c.py
# PURPOSE: Spoofs Plasma pump Control to 60 rpm

spoofName = "S-PSS-1.001c.py"
...
runner.AddCommand('spoof_main "-object CHwOrders -data plasmaRPM -value 60"\n','->',False)
...
# timeout
print "Plasma pump is being spoofed to 60 rpm for 30 seconds"
time.sleep(30)
