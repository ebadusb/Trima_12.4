...
runner.AddCommand('spoof_main "-object SHwStates -data acPumpAccum -mult 1 -offset 2"\n','->',False)
runner.AddCommand('spoof_main "-object SHwStates -data inletPumpAccum -mult 1 -offset 2"\n','->',False)
runner.AddCommand('spoof_main "-object SHwStates -data returnPumpAccum -mult 1 -offset 2"\n','->',False)
runner.AddCommand('spoof_main "-object SHwStates -data plasmaPumpAccum -mult 1 -offset 2"\n','->',False)
runner.AddCommand('spoof_main "-object SHwStates -data plateletPumpAccum -mult 1 -offset 4"\n','->',False)
