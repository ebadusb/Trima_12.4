# FILENAME: S-PSS-1.001d.py
# PURPOSE: Spoofs Return pump Control to 60 rpm

spoofName = "S-PSS-1.001d.py"
...
runner.AddCommand('spoof_main "-object CHwOrders -data returnRPM -value 60"\n','->',False)
...
# timeout
print "Return pump is being spoofed to 60 rpm for 30 seconds"
time.sleep(30)
