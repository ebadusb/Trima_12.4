# FILENAME: S-FOE-1.003d_rbc_to_open.py
# PURPOSE: Spoofs valve position state to "open" in safety system.

spoofName = "S-FOE-1.003d_rbc_to_open.py"
...
# add spoof commands
runner.AddCommand('spoof_main "-object SHwStates -data rbcValve -value HW_VALVE_OPEN"\n','->',False)
...
# timeout
print "RBC Valve is being spoofed to the Open position for 360 seconds."
time.sleep(360)
...
print "Unspoofing RBC Valve position..."
runner.Run()
