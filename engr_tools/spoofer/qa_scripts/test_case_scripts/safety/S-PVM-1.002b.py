# FILENAME: S-PVM-1.002b.py
# PURPOSE: Runs spoof 8.5.6 to spoof volume placed in Plasma bag such that it exceeds 1000 * 1.3 = 1300mL.
# NOTE: If altering this script to use another spoof, consider that the S-PVM-1.002a.py script will likely need to be updated also!!!
...
"""
	...
	3. Set the 'spoofName' variable below to be the same as the file name.
...
scriptName = "S-PVM-1.002b.py"

#******************************************************************************
# Automated Trima connection
#------------------------------------------------------------------------------
# DO NOT EDIT. This section automates the connection to the Trima device.
#******************************************************************************
...
# Commands are cached in the runner object, then executed in the order in which they are cached without pause.
#******************************************************************************
...
runner.AddCommand('spoof_main "-id 8.5.6"\n','->',False)
...
raw_input("During Blood Prime, press ENTER to run spoof 8.5.6:")
runner.Run()
...
raw_input("Spoofing done, press ENTER to close this window.");
