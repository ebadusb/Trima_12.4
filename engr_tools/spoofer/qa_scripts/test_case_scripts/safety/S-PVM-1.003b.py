# FILENAME: S-PVM-1.003b.py
# PURPOSE: Runs spoof 8.5.7b to spoof volume placed in a black stamp RBC bag such that it exceeds 1000 * 1.3 = 1300mL.
...
runner.AddCommand('spoof_main "-id 8.5.7b"\n','->',False)
...
raw_input("During Blood Prime, press ENTER to run spoof 8.5.7b:")
runner.Run()
