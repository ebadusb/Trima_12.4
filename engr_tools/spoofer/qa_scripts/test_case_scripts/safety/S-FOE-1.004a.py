...
runner.AddCommand('spoof_main "-enable -object SHwStates -data cassettePosition -value HW_CASSETTE_UNKNOWN"\n','->',False)
...
raw_input("At two button screen, press ENTER to spoof cassette position to 'UNKNOWN'.")
runner.Run()
...
#runner.AddCommand('spoof_main "-unspoof -object <Spoofed Object Here> -data <Spoofed Data Here>"\n','->',False)
raw_input("Cassette position is being spoofed to 'UNKNOWN', press ENTER to close this window.")
