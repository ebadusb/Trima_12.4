# FILENAME: S-PM-1.002a.py.py
# PURPOSE: .
scriptName = "S-PM-1.002a.py"
...
def load_and_run(runner):
    ...
    APSRaw = raw_input("Enter nominal APS raw value: ")
    runner.AddCommand('spoof_main "-enable -object CHwStates -data accessPressure -value ' + str(APSRaw)+ ' -trace"\n','->',False)
    ...
    #**************************************************************************************************************************
    raw_input('APS spoofed, press ENTER to spoof pump commanded speed: ')
    ...
    #Example command: runner.AddCommand('spoof_main "-enable -object CHwOrders -data acRPM -value 0.33 -enable"\n','->',False)
    #**************************************************************************************************************************
    runner.AddCommand('spoof_main "-id COInletRPM -var1 200 -var2 200"\n','->',False)
