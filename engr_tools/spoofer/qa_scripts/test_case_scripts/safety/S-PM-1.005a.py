# FILENAME: S-PM-1.005a.py.py
# PURPOSE: .
scriptName = "S-PM-1.005a.py"
...
def load_and_run(runner):
    ...
    runner.AddCommand('spoof_main "-object CHwOrders -data acRPM -mult 3 -offset 0 -trace"\n','->',False)
    runner.AddCommand('spoof_main "-object CHwOrders -data plasmaRPM -value 200"\n','->',False)
    runner.AddCommand('spoof_main "-object CHwOrders -data plateletRPM -value 200"\n','->',False)
    ...
    #**************************************************************************************************************************
    raw_input('Spoofed objects set, press ENTER at the beginning of the third draw cycle to activate spoof: ')
    ...
    #Example command: runner.AddCommand('spoof_main "-enable -object CHwOrders -data acRPM -value 0.33 -enable"\n','->',False)
    #**************************************************************************************************************************
    runner.AddCommand('spoof_main "-id EnableDisable -var1 3000 -var2 3250 -timeout 13"\n','->',False)
