# FILENAME: S-PM-1.003a.py
# PURPOSE: .
scriptName = "S-PM-1.003a.py"
...
def load_and_run(runner):
    ...
    runner.AddCommand('spoof_main "-object CHwStates -data accessPressure -mult 1 -offset 200 -trace"\n','->',False)
    runner.AddCommand('spoof_main "-id EnableDisable -var1 5000 -var2 5000 -timeout 20"\n','->',False)
    ...
    #**************************************************************************************************************************
    #raw_input('APS spoofed, press ENTER to APS raw value: ')
