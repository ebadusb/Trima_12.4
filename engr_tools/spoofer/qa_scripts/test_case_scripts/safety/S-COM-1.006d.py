# FILENAME: S-COM-1.006d.py
# PURPOSE: .
scriptName = "S-COM-1.006d.py"
...
def load_and_run(runner):
    ...
    runner.AddCommand('spoof_main "-object LatentSafetyStatusRequest -data delay -value ' + str(belowLimit) + ' -enable -trace"\n','->',False)
    runner.Run()
    runner.ResetCommands()      
    ...
    runner.AddCommand('spoof_main "-object LatentSafetyStatusRequest -data delay -value ' + str(aboveLimit) + ' -enable -trace"\n','->',False)
    runner.Run()
    runner.ResetCommands()  
