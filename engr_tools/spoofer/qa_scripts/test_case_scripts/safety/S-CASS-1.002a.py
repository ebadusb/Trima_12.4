# FILENAME: S-CASS-1002a.py
# PURPOSE: Spoofs Cassette to unknown position

spoofName = "S-CASS-1002a.py"
...
# timeout
print "This will spoof cassette to unknown position for 10 seconds"
time.sleep(10)
