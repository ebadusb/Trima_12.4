# FILENAME: S-PSS-1.002e.py
# PURPOSE: Spoofs AC pump Control to 60 rpm

spoofName = "S-PSS-1.002e.py"
...
runner.AddCommand('spoof_main "-object CHwOrders -data acRPM -value 60"\n','->',False)
...
# timeout
print "AC pump is being spoofed to 60 rpm for 30 seconds"
time.sleep(30)
