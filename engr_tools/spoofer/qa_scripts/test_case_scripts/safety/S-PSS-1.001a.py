# FILENAME: S-PSS-1.001a.py
# PURPOSE: Spoofs Inlet pump Control to 60 rpm

spoofName = "S-PSS-1.001a.py"
...
runner.AddCommand('spoof_main "-object CHwOrders -data inletRPM -value 60"\n','->',False)
...
# timeout
print "Inlet pump is being spoofed to 60 rpm for 30 seconds"
time.sleep(30)
