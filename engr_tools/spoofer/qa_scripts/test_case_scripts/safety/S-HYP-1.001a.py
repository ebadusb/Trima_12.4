...
#cmdLine = "spoof_main \"-enable -trace -object CHwStates -data plasmaRevs -value "+str(int(math.ceil((float((raw_input("Enter hypovolemia distance, then press enter:")))+25)/.88)))+"\"\n"
...
runner.AddCommand("spoof_main \"-enable -trace -object CHwStates -data plasmaRevs -value "+str(int(math.ceil((float((raw_input("Enter hypovolemia distance, then press enter:")))+25)/.88)))+"\"\n",'->',False)
#Example command: runner.AddCommand('spoof_main "-enable -object CHwOrders -data acRPM -value 0.33 -enable"\n','->',False)

raw_input("Once plasma valve is in the collect position, press enter:")
...
# runner.AddCommand('spoof_main "-unspoof -object CHwStates -data plasmaRPM"\n','->',False)
