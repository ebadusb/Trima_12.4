# FILENAME: S-PVM-1.001.py
# PURPOSE: Runs spoof 8.5.5 to spoof volume placed in Platelet bag such that it exceeds 1200 * 1.3 = 1560mL.
...
runner.AddCommand('spoof_main "-id 8.5.5"\n','->',False)
...
raw_input("During Blood Prime, press ENTER to run spoof 8.5.5:")
runner.Run()
