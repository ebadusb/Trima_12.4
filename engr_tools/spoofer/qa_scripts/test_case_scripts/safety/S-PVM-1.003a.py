# FILENAME: S-PVM-1.003a.py
# PURPOSE: Runs spoof 8.5.7a to spoof volume placed in a white stamp RBC bag such that it exceeds 500 * 1.3 = 650mL.
...
runner.AddCommand('spoof_main "-id 8.5.7a"\n','->',False)
...
raw_input("During Blood Prime, press ENTER to run spoof 8.5.7a:")
runner.Run()
