# FILENAME: S-FOE-1.003f_plasma_to_open.py
# PURPOSE: Spoofs Plasma valve position state to "open" in safety system.

spoofName = "S-FOE-1.003f_plasma_to_open.py"
...
# add spoof commands
runner.AddCommand('spoof_main "-object SHwStates -data plasmaValve -value HW_VALVE_OPEN"\n','->',False)
...
# timeout
print "Plasma Valve is being spoofed to the Open position for 360 seconds."
time.sleep(360)
