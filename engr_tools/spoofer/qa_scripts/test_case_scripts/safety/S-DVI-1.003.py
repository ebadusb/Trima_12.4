# FILENAME: S-DVI-1.003.py
# PURPOSE: This script will spoof an invalid gender.
...
runner.AddCommand('spoof_main "-enable -object DVitalsFromProc -data DonorSex -value Cylon"\n','->',False)
...
raw_input("At two button screen, press ENTER to spoof an invalid gender.");
...
#runner.AddCommand('spoof_main "-unspoof -object <Spoofed Object Here> -data <Spoofed Data Here>"\n','->',False)
raw_input("Gender spoofed, press ENTER to close this window.")
