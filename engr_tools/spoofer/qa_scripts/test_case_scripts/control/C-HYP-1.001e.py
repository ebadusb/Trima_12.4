# FILENAME: C-HYP-1.001e.py
# PURPOSE: .
scriptName = "C-HYP-1.001e.py"
...
def load_and_run(runner):
    ...
    limit = float(raw_input("Enter the volumetric limit determined by step 5 of the test: ")) #The product volume that can be removed from the donor before the "Procedures with plasma" limit is exceeded
    ...
    runner.AddCommand('spoof_main "-object ProcVolumes_Vac -data data -value 150"\n','->',False) # spoof 150 mL AC accum to get away from safety side mimic for black stamp sets
