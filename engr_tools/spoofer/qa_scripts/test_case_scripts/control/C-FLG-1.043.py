...
raw_input("\nWhen blood prime begins, press ENTER to run Part 1.\n");
...
raw_input("When collection begins, press ENTER to run Part 2.\n");
os.system('cls')
