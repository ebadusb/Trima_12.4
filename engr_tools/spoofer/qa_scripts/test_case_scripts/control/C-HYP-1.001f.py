# FILENAME: C-HYP-1.001f.py
# PURPOSE: .
scriptName = "C-HYP-1.001f.py"
...
def load_and_run(runner):
    ...
    limit = float(raw_input("Enter the WeightLimit calculated from step 5 of the test: ")) #The product volume that can be removed from the donor before the limit is exceeded
    ...
    runner.AddCommand('spoof_main "-object ProcVolumes_Vac -data data -value 250"\n','->',False) # spoof 250 mL AC accum to get away from safety side mimic
