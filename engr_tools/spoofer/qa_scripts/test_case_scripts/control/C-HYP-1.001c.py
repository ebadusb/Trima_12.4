# FILENAME: C-HYP-1.001c.py
# PURPOSE: .
scriptName = "C-HYP-1.001c.py"
...
def load_and_run(runner):
    ...
    limit = float(raw_input("Enter the configured volumetric limit for Procedures with platelets: ")) #The product volume that can be removed from the donor before the "Procedures with platelets" limit is exceeded
