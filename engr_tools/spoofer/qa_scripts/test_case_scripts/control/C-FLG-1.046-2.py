...
runner.AddCommand('spoof_main "-object CHwStates -data red -value 854"\n','->',False)
...
time.sleep(100)
runner.AddCommand('spoof_main "-unspoof -object ProcVolumes_PlasmaVolume"\n','->',False)
