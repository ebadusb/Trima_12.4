...
# PART 2 - spoof the integrated yield to cause the correct flags.
...
# Note: this is the same code as in C-FLG-1.051a.py, but we'll see different flagging/alerts because the config'd concentration is > 2500.
