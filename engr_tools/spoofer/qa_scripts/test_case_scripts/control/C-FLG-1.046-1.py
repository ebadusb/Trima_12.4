...
runner.AddCommand('spoof_main "-object ProcRun_IntegratedPlateletYield -data data -value 420000000000"\n','->',False)
runner.AddCommand('spoof_main "-object ProcVolumes_PlasmaVolume -data data -value 101"\n','->',False)
runner.AddCommand('spoof_main "-enable -trace"\n','->',False)
runner.AddCommand('spoof_main "-id SubstateAlert -timeFromActive 120 -var1 PCA -var2 0 -beginSubstate PlateletConcentrationAdjustment"\n','->',False)
