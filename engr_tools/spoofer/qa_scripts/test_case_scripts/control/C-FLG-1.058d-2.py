# FILENAME: C-FLG-1.058d-2.py
# PURPOSE: .
scriptName = "C-FLG-1.058d-2.py"
...
def load_and_run(runner):
    ...
    #Templates:
    runner.AddCommand('spoof_main "-object ProcRunTargets_SelectedPlateletVolume -data data -mult 0 -value 220"\n','->',False)
    runner.AddCommand('spoof_main "-object ProcVolumes_PlateletVolume -data data -mult 0 -value 243"\n','->',False)
