...
runner.AddCommand('spoof_main "-object CHwStates -data red -value 400"\n','->',False)
runner.AddCommand('spoof_main "-object CHwStates -data green -value 300"\n','->',False)
...
#Cache commands to be executed.
#-enable option needs to be added either as a standalone command or as an option in another command.
runner.AddCommand('spoof_main "-object CHwStates -data green -value 625"\n','->',False)
runner.AddCommand('spoof_main "-object CHwStates -data red -value 650"\n','->',False)
