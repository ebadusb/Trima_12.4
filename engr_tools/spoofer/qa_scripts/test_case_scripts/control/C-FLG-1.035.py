...
# PART 1 - spoof red/green values during cassette loading to cause RBC calibration alarm
...
# PART 2 - spoof red/green values during prime substates to avoid unwanted flags
...
# PART 3 - spoof red/green values during collect substates to avoid unwanted flags
