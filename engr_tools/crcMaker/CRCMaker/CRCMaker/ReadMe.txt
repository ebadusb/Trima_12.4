========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : CRCMaker
========================================================================


AppWizard has created this CRCMaker application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your CRCMaker application.
...
CRCMaker.h
    ...
    CCRCMakerApp application class.
...
res\CRCMaker.ico
    ...
    icon is included by the main resource file CRCMaker.rc.
...
CRCMakerDlg.h, CRCMakerDlg.cpp - the dialog
    These files contain your CCRCMakerDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in CRCMaker.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CCRCMakerDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named CRCMaker.pch and a precompiled types file named StdAfx.obj.
