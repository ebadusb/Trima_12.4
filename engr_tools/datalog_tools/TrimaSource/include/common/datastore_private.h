 ...
 * HISTORY:    Revision 1.1  2009/01/29 17:57:17Z  jsylusb
 * HISTORY:    Initial revision
 * HISTORY:    Revision 1.1  2008/08/02 17:26:26Z  ssunusb
 * HISTORY:    Initial revision
...
template<> inline void BaseElement<bool>::Access(AccessOp op) const { UNUSED_ARGUMENT(op);}
template<> inline void BaseElement<char>::Access(AccessOp op) const { UNUSED_ARGUMENT(op);}
template<> inline void BaseElement<unsigned char>::Access(AccessOp op) const { UNUSED_ARGUMENT(op);}
template<> inline void BaseElement<short>::Access(AccessOp op) const { UNUSED_ARGUMENT(op);}
template<> inline void BaseElement<unsigned short>::Access(AccessOp op) const {UNUSED_ARGUMENT(op); }
template<> inline void BaseElement<int>::Access(AccessOp op) const { UNUSED_ARGUMENT(op);}
template<> inline void BaseElement<unsigned int>::Access(AccessOp op) const { UNUSED_ARGUMENT(op);}
template<> inline void BaseElement<long>::Access(AccessOp op) const { UNUSED_ARGUMENT(op);}
template<> inline void BaseElement<unsigned long>::Access(AccessOp op) const { UNUSED_ARGUMENT(op);}
...
template <class dataType> void BaseElement<dataType>::CreateSymbolTableEntry()
{
   ...
   //cout << "created data " << (int)(_handle->_data) << " for " << (int)_handle << endl;
