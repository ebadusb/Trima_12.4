 ...
 *
 * $Header: //bctquad3/home/BCT_Development/Trima5.R/Trima/engr_tools/datalog_tools/Trima/include/common/rcs/datalog_private.h 1.1 2009/01/29 17:57:16Z jsylusb Exp $
 * $Log: datalog_private.h $
 * Revision 1.1  2009/01/29 17:57:16Z  jsylusb
 * Initial revision
 * Revision 1.1  2008/08/02 17:25:15Z  ssunusb
 * Initial revision
...
{
// memory leak offline since creation of log set stubbed out   DataLog_PeriodicItemRef<Value> * item = new DataLog_PeriodicItemRef<Value>(handle, ref, key, description, format);
   return DataLog_OK;
}
...
{
   DataLog_PeriodicItemStringRef * item = new DataLog_PeriodicItemStringRef(handle, ref, key, description, format);
   UNUSED_ARGUMENT(item);   return DataLog_OK;
}
