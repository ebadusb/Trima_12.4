namespace ExcelFormater.Windows {
	partial class TableMacroWindow {
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.mSelectedList.TabIndex = 36;
			// 
			// mAvailableList
			// 
			...
			this.mAvailableList.TabIndex = 35;
			...
			this.mCancelButton.TabIndex = 34;
			...
			this.mFunctionTextfield.TabIndex = 32;
			// 
			// mFunctionLabel
			// 
			...
			this.mFunctionLabel.TabIndex = 31;
			...
			this.mNameTextfield.TabIndex = 30;
			// 
			// mNameLabel
			// 
			...
			this.Name = "TableMacroWindow";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Table Macro";
